...
const available = !!(NativeModules.ExponentGLObjectManager && NativeModules.ExponentGLObjectManager.createCameraTextureAsync);

let warned = false;

class ExpoCameraTextureLoader extends WebGLTextureLoaderAsyncHashCache {
  constructor(...args) {
    var _temp;
